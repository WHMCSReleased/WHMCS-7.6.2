...
$_ADMINLANG['configservers']['statusaddressdesc'] = "Per mostrare questo server nella pagina dello stato dei server, inserisci il percorso completo alla cartella dello stato del server (è richiesto per ciascun server che vuoi monitorare) - es. http://www.whmcs.com/statoserver/";
...
$_ADMINLANG['eNomNameSpinner']['createAnAccount'] = "Crea un account gratuitamente, con <strong> attivazione istantanea </strong>. <a href=\"http://www.whmcs.com/partners/enom/\" target=\"_blank\">Scopri di più...</a>";
...
$_ADMINLANG['eNomNameSpinner']['ensureAuthorizedIp'] = "Assicurati di aver autorizzato l'indirizzo IP esterno di questo server per l'accesso API con eNom. <a href=\"http://docs.whmcs.com/Enom\" target=\"_blank\">Aiuto?</a>";
...
$_ADMINLANG['healthCheck']['usingDefaultPathsFailure'] = "<p>La personalizzazione dei percorsi di directory predefiniti per alcune parti di WHMCS rende più difficile per gli utenti malintenzionati trovarli. L'installazione sta attualmente utilizzando i seguenti percorsi predefiniti:</p><ul>:nonCustomPaths</ul><p>Informati nella nostra guida <a href=\"http://docs.whmcs.com/Further_Security_Steps\">Successivi passi Sicurezza</a> per vedere come cambiarli.</p>";
